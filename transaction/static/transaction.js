          ...
          if ($this.hasClass('actions')) {
            ...
            switch(i) {
              ...
              case 2:
                break;
              case 3:
                $this.html('<input type="number" class="form-control" value="' + data[i] + '"/>');
                break;
              case 4:
                $this.html('<textarea class="form-control" rows=5>' + data[i] + '</textarea>');
                break;
              case 5:
                $this.html('<div class="input-group"><span class="input-group-addon"><i class="icon md-calendar" aria-hidden="true"></i></span><input type="text" class="form-control transDate"></div>');
                break;
            }
          }
        });
      ...
      rowSave: function rowSave($row) {
        ...
        values = $row.find('td').map(function (i) {
          ...
          if ($this.hasClass('actions')) {
            ...
            return $$$1.trim($this.find('select, input, textarea').val());
          }
        });
